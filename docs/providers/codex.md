...
This guide is for people who want to use more than one Codex account in k3code.
...
In k3code Settings, name it something obvious:
...
In k3code Settings, add another Codex provider:
...
k3code shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, k3code treats it
